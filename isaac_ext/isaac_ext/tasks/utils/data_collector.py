...
class GymDataCollector:
    ...
    def add_step(
        ...
        self.terminal_buffer.append(terminal.detach().cpu())
    ...
    def flush(self):
        ...
        with h5py.File(self.file_path, "a") as f:
            ...
            terminal_array = torch.stack(self.terminal_buffer).numpy()
            ...
            f.create_dataset("terminals", data=terminal_array, compression="gzip")
